{{-- form key picker matching select input design --}}
<template x-if="field.type === 'form'">
    <div>
        ...
        <div class="relative" x-data="{ open: false }">
            ...
            >
                <span class="flex-1 text-left truncate" x-text="getFormKeyOptions(field).find(o => o.value === getField(field.name))?.label || (getField(field.name) || 'Select...')"></span>
            ...
            >
                ...
                <template x-if="getFormKeyOptions(field).length === 0">
                    <div class="px-3 py-2 text-sm text-gray-400">Select a Form first to pick keys</div>
                </template>
            </div>
        </div>
    </div>
