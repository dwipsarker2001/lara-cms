...
<div class="flex h-full flex-col">
    <div id="editor-top-bar" class="hidden">
        <div class="flex items-center gap-3">
            <a id="btn-back" href="{{ route('admin.email-templates.index') }}" class="size-7 shrink-0 flex items-center justify-center rounded-full border border-gray-300 bg-white text-text-primary hover:bg-gray-100 transition-colors">
