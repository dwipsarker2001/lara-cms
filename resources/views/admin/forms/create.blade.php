...
@section('content')
    <div class="max-w-5xl mx-auto px-2 sm:px-0" x-data="formBuilderForm()">
        ...
        <form id="form-builder" method="POST" action="{{ route('admin.forms.store') }}">
            @csrf
                ...
                <div class="px-1.5 pb-2">
                    <div class="bg-content-bg rounded-xl ring-1 ring-content-border shadow-sm px-3 py-3">
                        ...
                        <div class="grid md:grid-cols-2 items-start px-[18px] py-4 gap-y-3 md:gap-y-0 md:gap-x-5">
                            ...
                            <div class="flex items-center gap-2">
                                <div class="flex-1">
                                    <textarea id="field-description" name="description" placeholder="Fill out this form to get in touch with us." class="w-full block bg-content-bg border border-content-border text-text-primary placeholder:text-text-muted text-sm rounded-lg px-3 py-2 min-h-[60px] resize-y transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary">{{ old('description') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid md:grid-cols-2 items-start px-[18px] py-4 gap-y-3 md:gap-y-0 md:gap-x-5">
                            ...
                            <div class="flex items-center gap-2">
                                <div class="flex-1">
                                    <input type="text" name="submit_text" value="{{ old('submit_text', 'Submit') }}" class="w-full block bg-content-bg border border-content-border text-text-primary placeholder:text-text-muted text-sm rounded-lg px-3 py-2 h-9 transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid md:grid-cols-2 items-start px-[18px] py-4 gap-y-3 md:gap-y-0 md:gap-x-5">
                            ...
                            <div class="flex items-center gap-2">
                                <div class="flex-1">
                                    <input type="text" name="success_message" value="{{ old('success_message', 'Thank you for your submission!') }}" class="w-full block bg-content-bg border border-content-border text-text-primary placeholder:text-text-muted text-sm rounded-lg px-3 py-2 h-9 transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid md:grid-cols-2 items-start px-[18px] py-4 gap-y-3 md:gap-y-0 md:gap-x-5">
                            ...
                            <div class="flex items-center gap-2">
                                <div class="flex-1">
                                    <input id="field-per_page" type="number" name="per_page" min="1" max="500" value="{{ old('per_page', 15) }}" class="w-full block bg-content-bg border border-content-border text-text-primary placeholder:text-text-muted text-sm rounded-lg px-3 py-2 h-9 transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary">
                                </div>
                            </div>
                        </div>
