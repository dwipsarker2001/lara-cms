...
@section('title', 'Edit Package — '.$plan->name)
...
<div class="max-w-5xl mx-auto px-2 sm:px-0">
    ...
    <form id="plan-form" method="POST" action="{{ route('admin.subscription-plans.update', $plan) }}">
        @csrf @method('PUT')
                        ...
                        <div class="divide-y divide-content-border">
                            <div class="grid md:grid-cols-2 items-start px-[18px] py-4 gap-y-3 md:gap-y-0 md:gap-x-5">
                                <div class="flex flex-col gap-1.5">
                                    ...
                                    <div class="text-sm text-text-muted">The name of this subscription package.</div>
                                </div>
                                <div>
                                    <input id="name" type="text" name="name" value="{{ old('name', $plan->name) }}" class="w-full block bg-content-bg border border-content-border text-text-primary placeholder:text-text-muted text-sm rounded-lg px-3 py-2 h-9 transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary">
                            ...
                            <div class="grid md:grid-cols-2 items-start px-[18px] py-4 gap-y-3 md:gap-y-0 md:gap-x-5">
                                ...
                                <div>
                                    <input id="price" type="number" step="0.01" name="price" value="{{ old('price', $plan->price) }}" min="0" class="w-full block bg-content-bg border border-content-border text-text-primary placeholder:text-text-muted text-sm rounded-lg px-3 py-2 h-9 transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary">
                            ...
                            <div class="grid md:grid-cols-2 items-start px-[18px] py-4 gap-y-3 md:gap-y-0 md:gap-x-5">
                                ...
                                <div>
                                    <input id="max_emails" type="number" name="max_emails" value="{{ old('max_emails', $plan->max_emails) }}" min="0" class="w-full block bg-content-bg border border-content-border text-text-primary placeholder:text-text-muted text-sm rounded-lg px-3 py-2 h-9 transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary">
                            ...
                            <div class="grid md:grid-cols-2 items-start px-[18px] py-4 gap-y-3 md:gap-y-0 md:gap-x-5">
                                ...
                                <div>
                                    <input id="max_contacts" type="number" name="max_contacts" value="{{ old('max_contacts', $plan->max_contacts) }}" min="0" class="w-full block bg-content-bg border border-content-border text-text-primary placeholder:text-text-muted text-sm rounded-lg px-3 py-2 h-9 transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary">
                            ...
                            <div class="grid md:grid-cols-2 items-start px-[18px] py-4 gap-y-3 md:gap-y-0 md:gap-x-5">
                                ...
                                <div>
                                    <input id="max_campaigns" type="number" name="max_campaigns" value="{{ old('max_campaigns', $plan->max_campaigns) }}" min="0" class="w-full block bg-content-bg border border-content-border text-text-primary placeholder:text-text-muted text-sm rounded-lg px-3 py-2 h-9 transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary">
                            ...
                            <div class="grid md:grid-cols-2 items-start px-[18px] py-4 gap-y-3 md:gap-y-0 md:gap-x-5">
                                ...
                                <div>
                                    <input id="max_groups" type="number" name="max_groups" value="{{ old('max_groups', $plan->max_groups) }}" min="0" class="w-full block bg-content-bg border border-content-border text-text-primary placeholder:text-text-muted text-sm rounded-lg px-3 py-2 h-9 transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary">
                            ...
                            <div class="grid md:grid-cols-2 items-start px-[18px] py-4 gap-y-3 md:gap-y-0 md:gap-x-5">
                                ...
                                <div class="flex justify-end"><label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="set_as_default" value="1" {{ $plan->id === $defaultPlanId ? 'checked' : '' }} class="sr-only peer">
