                                        ...
                                        <div class="flex items-center gap-2">
                                            <div class="flex-1">
                                                ...
                                                @elseif($fType === 'select')
                                                    ...
                                                    @endphp
                                                    <div x-data="{ open: false, selectedVal: '{{ $val }}' }" @click.outside="open = false" class="relative">
                                                ...
                                                @elseif($fType === 'collection')
                                                    @php
                                                        ...
                                                        $selectedEntry = $targetEntries->firstWhere('id', $val);
                                                        $selectedLabel = $selectedEntry?->title ?? $selectedEntry?->data['title'] ?? 'Choose entry...';
                                                    @endphp
                                                    <div x-data="{ open: false, selectedValue: @js((string)$val), label: @js((string)$selectedLabel) }" @click.outside="open = false" @keydown.escape.window="open = false" class="relative">
                                                ...
                                                @elseif($fType === 'taxonomies')
                                                    @php
                                                        ...
                                                        $selectedTerm = $targetTerms->firstWhere('id', $val);
