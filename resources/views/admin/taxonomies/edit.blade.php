...
@section('content')
    <div
        ...
        x-data="{
            title: '{{ old('title', addslashes($taxonomy->title)) }}',
            slug: '{{ old('slug', addslashes($taxonomy->slug)) }}',
            description: '{{ old('description', addslashes($taxonomy->description ?? '')) }}',
        }"
    >
        <form method="POST" action="{{ route('admin.taxonomies.update', $taxonomy) }}">
            ...
            <div class="bg-panel-bg rounded-2xl mb-8 p-[7px]">
                ...
                <p class="px-[18px] pb-3 text-sm text-text-muted">Update this taxonomy group configuration.</p>
                        ...
                        <div class="divide-y divide-content-border">
                            ...
                            <div class="grid md:grid-cols-2 items-start px-[18px] py-4 gap-y-3 md:gap-y-0 md:gap-x-5">
                                <div class="flex flex-col gap-1.5">
                                    ...
                                    <div class="text-sm text-text-muted">Optional description for this taxonomy.</div>
                                </div>
                                <div class="flex items-center gap-2">
                                    <div class="flex-1">
                                        <textarea
