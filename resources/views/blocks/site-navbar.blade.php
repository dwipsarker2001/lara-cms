            ...
            <div class="mx-auto max-w-7xl px-6">
                <div class="flex items-center justify-between py-6">
                    <a href="/" class="flex items-center gap-2">
                        @if($d['logo'] ?? false)
                            <img src="{{ $d['logo'] }}" alt="Logo" data-edit="logo" class="object-contain" style="height: {{ $d['logoHeight'] ?? 40 }}px; width: auto" />
                        @else
                            <span class="text-xl font-bold text-gray-900">Block CMS</span>
                        @endif
                    </a>
