...
<section data-block="pageBanner">
    <div data-edit="backgroundImage" class="relative flex min-h-[320px] md:min-h-[400px] items-center justify-center overflow-hidden rounded-none md:mx-[5%] md:my-4 md:rounded-2xl">
