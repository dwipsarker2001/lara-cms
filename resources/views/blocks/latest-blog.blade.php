@php $d = $data; @endphp
<section data-block="latestBlog" class="bg-white py-20 md:py-28">
    <div class="mx-auto max-w-7xl px-4">
        ...
        @if($preview)
            <div class="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                @for($i = 0; $i < 3; $i++)
                    <div class="animate-pulse overflow-hidden rounded-2xl bg-neutral-100 shadow-sm ring-1 ring-neutral-100">
                        <div class="aspect-[16/9] bg-neutral-200"></div>
