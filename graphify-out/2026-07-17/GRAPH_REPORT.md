...
## Corpus Check
- 270 files · ~116,757 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1329 nodes · 1635 edges · 221 communities (176 shown, 45 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 81 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d5b3cf8a`
...
### Community 3 - "Page"
Cohesion: 0.11
Nodes (6): PageController, Request, PageController, Page, Sections, HomePageSeeder
...
### Community 7 - "Model"
Cohesion: 0.13
Nodes (9): AssetsController, Request, Asset, Booking, Destination, BelongsToMany, Term, BelongsTo (+1 more)

### Community 8 - "LoginController.php"
Cohesion: 0.07
Nodes (18): RedirectResponse, View, ProfileController, Request, SeoController, RedirectResponse, Request, View (+10 more)
...
Cohesion: 0.05
Nodes (24): AdminUserController, RedirectResponse, Request, View, Admin, BelongsToMany, User, Authenticatable (+16 more)
...
Cohesion: 0.16
Nodes (7): Request, PreviewController, Request, SettingsController, Controller, Setting, BlockPreview
...
- **Why does `Block` connect `Block` to `Taxonomy`, `BlockRegistry`, `Field.php`, `BlogPostSlot.php`, `ClientTestimonials.php`, `FeatureImageCards.php`, `LatestBlog.php`, `PackageList.php`, `PackagePostSlot.php`, `TeamCards.php`, `TravelDeals.php`, `WhyChooseUs.php`, `SiteFooter.php`, `SiteNavbar.php`, `SiteTopBar.php`, `BlogList.php`, `BlogSection.php`, `PackageFaq.php`, `PackageFeatures.php`, `PackageGalleryHero.php`, `PackageHero.php`, `PackageInfo.php`, `PackageLocations.php`, `PackageMap.php`, `SimpleText.php`, `TravelDeals.php`, `ProfileBento.php`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `Layout` connect `Layout` to `Page`, `Controller`, `Model`, `RedirectResponse`, `View`, `Package`, `Seeder`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `Admin` connect `Seeder` to `LoginController.php`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
