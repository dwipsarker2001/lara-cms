...
## Corpus Check
- 284 files · ~120,412 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1367 nodes · 1698 edges · 234 communities (189 shown, 45 thin omitted)
...
Cohesion: 0.24
Nodes (4): Request, TaxonomyController, Taxonomy, HasMany
...
Cohesion: 0.08
Nodes (16): RedirectResponse, Request, View, UserController, User, AdminFactory, static, FormFactory (+8 more)
...
### Community 137 - "View"
Cohesion: 0.08
Nodes (14): AdminUserController, RedirectResponse, Request, View, Request, PostController, BlogController, Admin (+6 more)
...
- **Why does `Controller` connect `RedirectResponse` to `Term.php`, `Page`, `Controller`, `Model`, `View`, `Taxonomy`, `Package`, `Layout`, `Seeder`, `SeoController.php`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `Field` connect `Field` to `Block`, `Field.php`, `BlogPostSlot.php`, `ClientTestimonials.php`, `FeatureImageCards.php`, `LatestBlog.php`, `PackageList.php`, `PackagePostSlot.php`, `TeamCards.php`, `TravelDeals.php`, `WhyChooseUs.php`, `SiteFooter.php`, `SiteNavbar.php`, `SiteTopBar.php`, `BlogList.php`, `BlogSection.php`, `PackageFaq.php`, `PackageFeatures.php`, `PackageGalleryHero.php`, `PackageHero.php`, `PackageInfo.php`, `PackageLocations.php`, `PackageMap.php`, `SimpleText.php`, `TravelDeals.php`, `ProfileBento.php`?**
