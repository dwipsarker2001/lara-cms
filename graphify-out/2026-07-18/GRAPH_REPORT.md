...
## Corpus Check
- 346 files · ~145,994 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1598 nodes · 2040 edges · 282 communities (230 shown, 52 thin omitted)
...
### Community 3 - "Page"
Cohesion: 0.25
Nodes (7): RedirectResponse, Request, View, UserController, User, HasFactory, Notifiable
...
Cohesion: 0.05
Nodes (18): FormController, Request, PackageController, Request, PageController, Booking, Destination, Form (+10 more)
...
Cohesion: 0.06
Nodes (12): BlockRegistry, CollectionController, Request, CollectionEntryController, Request, Collection, HasMany, CollectionEntry (+4 more)
...
### Community 236 - "User"
Cohesion: 0.07
Nodes (15): Request, PostController, BlogController, BelongsToMany, Post, AdminFactory, static, CollectionFactory (+7 more)

### Community 238 - "Post.php"
Cohesion: 0.25
Nodes (3): LoginRequest, ProfileUpdateRequest, FormRequest
...
- **Why does `Block` connect `Block` to `@tiptap/extension-link`, `Taxonomy`, `BlockRegistry`, `Field.php`, `AppServiceProvider.php`, `BlogPostSlot.php`, `ClientTestimonials.php`, `FeatureImageCards.php`, `PackageList.php`, `PackagePostSlot.php`, `TeamCards.php`, `TravelDeals.php`, `WhyChooseUs.php`, `SiteFooter.php`, `SiteNavbar.php`, `SiteTopBar.php`, `BlogSection.php`, `PackageFaq.php`, `PackageFeatures.php`, `PackageGalleryHero.php`, `PackageHero.php`, `PackageInfo.php`, `PackageLocations.php`, `PackageMap.php`, `SimpleText.php`, `TravelDeals.php`, `Collection`, `ProfileBento.php`, `@codemirror/lang-json`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `Controller` connect `Sections` to `UserController`, `ProfileController.php`, `Page`, `Model`, `LoginController.php`, `View`, `BlogList.php`, `User`, `BlockRegistry`, `AppServiceProvider.php`, `.view`, `Collection`, `Factory`, `Seeder`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `Page` connect `BlogList.php` to `UserController`, `PagesWidget`, `AppServiceProvider.php`, `LatestBlog.php`, `Collection`, `Sections`?**
