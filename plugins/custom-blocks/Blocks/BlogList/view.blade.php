@php
    ...
    if (\Illuminate\Support\Facades\Schema::hasTable('collection_entries')) {
        ...
        $blockInstance = new \Plugins\CustomBlocks\Blocks\BlogList\BlogList();
        ...
        $sidebarCategories = \Plugins\CustomBlocks\Support\BlogSidebarData::getCategories($selectedCollection, $categoryTaxonomy);
        $sidebarTags = \Plugins\CustomBlocks\Support\BlogSidebarData::getTags($selectedCollection, $tagTaxonomy);
        $sidebarRecentPosts = \Plugins\CustomBlocks\Support\BlogSidebarData::getRecentPosts(3, $selectedCollection);
    }
